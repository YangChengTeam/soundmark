...
/**
 * Created by caokun on 2019/11/8 15:52.
 */

public class VideoAudioFocusManager {

    public String TAG = "VideoPlay_VideoAudioFocusManager";
        ...
        public void onAudioFocusChange(int focusChange) {
            ...
            switch (focusChange) {
                ...
                case AudioManager.AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK:
                    Log.d(TAG, "onAudioFocusChange: 重新获取到了焦点");
                ...
                case AudioManager.AUDIOFOCUS_LOSS:
                    Log.d(TAG, "onAudioFocusChange: 被其他播放器抢占");
                    if (null != mFocusListener) {
